...
const Register = () => {
  ...
  <form class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
    <div>
      <h1 class="text-3xl font-bold text-center mb-4 cursor-pointer">Log in here!</h1>
      <p class="w-80 text-center text-sm mb-8 font-semibold text-gray-700 tracking-wide cursor-pointer">Please enter your Email address and password below</p>
    </div>
    <div class="space-y-4">
    ...
    <div class="text-center mt-6">
      <button class="w-full py-2 text-xl text-white bg-purple-400 rounded-lg hover:bg-purple-500 transition-all">Log in</button>
      <p class="mt-4 text-sm">Don't have an account? <span class="underline  cursor-pointer"> Register here</span></p>
    </div>
  </form>
