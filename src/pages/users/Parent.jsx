    ...
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      <div class="p-4 md:w-1/3 flex">
        ...
        <div class="flex-grow pl-6">
          <h2 class="text-white text-lg title-font font-medium mb-2">{user.name}</h2>
          <ul>
            <li>Email: {user.email}</li>
            <li>Patient number: {user.patient_number}</li>
            <li>Appointment date: {user.appointment_date}</li>
            <li>Appointment notes: {user.appointment_notes}</li>
            <li>Department ID: {user.department_id.name}</li>
          </ul>
